...
<head>
  ...
  <meta name="description" content="Book Golden Triangle Tour 3 Days covering Delhi, Agra & Jaipur with luxury hotels, private guides and curated heritage experiences.">
  ...
  <script type="application/ld+json">
  {
    ...
    "itinerary": [
      "Delhi: India Gate, Qutub Minar, Humayun’s Tomb, Lotus Temple, Parliament Drive",
      "Agra: Taj Mahal sunrise, Agra Fort, Fatehpur Sikri en route to Jaipur",
    ...
    "image": [
      "assets/images/tours/golden-triangle-tour-3-days.jpg",
      "assets/images/tours/taj-mahal-sunrise.jpg",
      "assets/images/tours/amber-fort-jaipur.jpg"
    ],
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is 3 days enough for Golden Triangle Tour?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, this itinerary is ideal for travelers seeking India’s top cultural highlights in a short time."
        }
      },
      {
        "@type": "Question",
        "name": "What cities are included?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Delhi, Agra and Jaipur."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely—premium hotels, private transport and personalized guides ensure comfort."
        }
      }
    ]
  }
      ...
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/gtimages/gt1.jpg" alt="Golden Triangle Tour 3 Days photo 1">
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/gtimages/gt2.jpg" alt="Golden Triangle Tour 3 Days photo 2">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt1.jpg"}, {"src": "assets/images/gtimages/gt2.jpg"}, {"src": "assets/images/gtimages/gt3.jpg"}, {"src": "assets/images/gtimages/gt4.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/gtimages/gt3.jpg" alt="Golden Triangle Tour 3 Days photo 3">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt1.jpg"}, {"src": "assets/images/gtimages/gt2.jpg"}, {"src": "assets/images/gtimages/gt3.jpg"}, {"src": "assets/images/gtimages/gt4.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/gtimages/gt4.jpg" alt="Golden Triangle Tour 3 Days photo 4">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt1.jpg"}, {"src": "assets/images/gtimages/gt2.jpg"}, {"src": "assets/images/gtimages/gt3.jpg"}, {"src": "assets/images/gtimages/gt4.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
              ...
              <div class="tour-listing-details__destination-right">
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.1s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">3 Days</h4>
                  </div>
                </div>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">The 3 Days Imperial Golden Triangle Tour Begins From Delhi, Where You Will Be Greeted By Our
                        ...
                        Masjid, Which Is The Largest Mosque Of The Country In The Heart Of The City, And Then Proceed To
                        Chandni Chowk, One Of The Old Markets Of Delhi. Later, You Can Visit India Gate, The Famous War
                        Memorial Committed To The Valiant Indian Soldiers.<Br>
                        <Br>
                        You Can Even Drive Past The President House And The Parliament House. You Will Also Be Taken To
                        Visit Raj Ghat, Qutub Minar, And Humayun's Tomb. From Here, Take The Express Highway To Agra,
                        Which Is Approximately 210 Kms And Takes Around 3 Hrs To Cover The Distance. On Reaching Agra
                        Take Dinner In A Popular Restaurant Of Agra. Night Stay Will Be In The Hotel In Agra.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">Our Tour Guide Will Pick You From Your Hotel Around 6:00 A.M. For A Sunrise Tour Of the Taj
                        Mahal. The Taj Mahal Is Famous For Exhibiting Diverse Hues During Different Parts Of The Day.
                        During Sunrise It Adorns A Pink Shade. The Superb Craftsmanship And Fascinating Structural
                        Design Enchants All The Tourists Coming Here. This Majestic Taj Mahal Sprawling On The Bank Of
                        The Yamuna River Is an Overwhelming And Inspiring Illustration Of the Divine Love Of Mughal
                        Emperor Shah Jahan For His Wife, Mumtaz. From Here, You Will Be Taken To Visit The Popular
                        Landmark, Agra Fort, Which Is Constructed In Red Sandstone And Is A Symbol Of Valor And
                        Strength.<Br>
                        <Br>
                        Come Back To The Hotel For Breakfast, And After That, Leave For Jaipur. Enroute You Can Visit
                        Fatehpur Sikri, Which Was Once The Capital City Of Akbar The Great. People Soon Migrated From
                        Here Owing To The Dearth Of Water. Proceed To Jaipur, And The Night Stay Will Be In Jaipur.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 3</span> Jaipur - Delhi (260 Kms)</h4>
                  </div>
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">After An Early Breakfast In The Hotel In Jaipur, Leave For The Sightseeing. Begin From The Amer
                        Fort, Which Placed At The Top Of The Aravalli Hill. Enjoy The Elephant Ride That Takes You To
                        The Fort, Which Is An Incredible Experience. From Here, You Can Head To The City Palace, Which
                        Is An Amazing Blend Of Mughal And Rajput Architecture. After This Head Straight To Jal Mahal,
                        Hawa Mahal And Jantar Mantar, Which Are The Landmark Destinations Of Jaipur.<Br>
                        <Br>
            ...
            <div class="tour-listing-details__plan">
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="priority-seo-faq">
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title"><h4>Is 3 days enough for the Golden Triangle?<span class="faq-arrow" style="float:right;color:#ffc202;font-size:13px;transition:transform 0.3s;"><i class="fas fa-chevron-down"></i></span></h4></div>
