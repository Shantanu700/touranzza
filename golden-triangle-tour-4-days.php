...
<head>
  ...
  <link rel="canonical" href="https://touranzza.com/golden-triangle-tour-4-days" />
      ...
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image" style="background-image:url(assets/images/gtimages/gt5.jpg);" aria-label="Golden Triangle Tour 4 Days photo 1">
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image" style="background-image:url(assets/images/gtimages/gt6.jpg);" aria-label="Golden Triangle Tour 4 Days photo 2">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt5.jpg"}, {"src": "assets/images/gtimages/gt6.jpg"}, {"src": "assets/images/gtimages/gt7.jpg"}, {"src": "assets/images/gtimages/gt8.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image" style="background-image:url(assets/images/gtimages/gt7.jpg);" aria-label="Golden Triangle Tour 4 Days photo 3">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt5.jpg"}, {"src": "assets/images/gtimages/gt6.jpg"}, {"src": "assets/images/gtimages/gt7.jpg"}, {"src": "assets/images/gtimages/gt8.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image" style="background-image:url(assets/images/gtimages/gt8.jpg);" aria-label="Golden Triangle Tour 4 Days photo 4">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/gtimages/gt5.jpg"}, {"src": "assets/images/gtimages/gt6.jpg"}, {"src": "assets/images/gtimages/gt7.jpg"}, {"src": "assets/images/gtimages/gt8.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
              ...
              <div class="tour-listing-details__destination-right">
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.1s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">4 Days</h4>
                  </div>
                </div>
                ...
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.7s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">Delhi, Agra, Jaipur</h4>
                  </div>
                </div>
                <!-- /.tour-listing-details__destination-info -->
              </div>
          ...
          <div class="col-xl-8">
            <div class="tour-listing-details__overview">
              ...
              <p class="tour-listing-details__overview-text wow animated fadeInUp" data-wow-delay="0.1s"
                data-wow-duration="1500ms">The Golden Triangle Tour 4 Days gives you a more balanced Delhi Agra Jaipur itinerary than the 3-day express route, while still keeping the journey compact. You get time for Old Delhi and New Delhi, a dedicated Agra stay for the Taj Mahal, and a Jaipur sightseeing day with Amer Fort, Hawa Mahal, City Palace and Jantar Mantar. This private tour is a strong choice for couples, families and first-time India visitors who want the Taj Mahal, Mughal history, Rajput architecture and market culture without committing to a long holiday. For a deeper version, continue to the <a href="golden-triangle-tour-6-days" style="color: inherit; text-decoration: underline; font-weight: 600;">Golden Triangle Tour 6 Days</a> or add Rajasthan with our <a href="golden-triangle-tour-with-rajasthan" style="color: inherit; text-decoration: underline; font-weight: 600;">Golden Triangle with Rajasthan</a>.</p>
</div>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 1</span> Delhi - Agra (210 Kms)</h4>
                  </div>
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">This 4 Days Imperial Golden Triangle Tour Starts From The Capital City Of Delhi. You, Will, Be Greeted
                ...
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 2</span> Agra - Fatehpur Sikri - Jaipur(250 Kms)</h4>
                  </div>
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">After Early Breakfast, Proceed For The Thrilling Sightseeing Tour Of Delhi. Visit Majestic Jama
                        Masjid, Red Fort, And Explore By Lanes Of Chandni Chowk. Enjoy Sumptuous Lunch in a Local
                        Restaurant. Visit India Gate, Raj Ghat, Rashtrapati Bhawan, Humayun's Tomb, Qutub Minar. Later,
                        You Will Be Driven By Car Via Yamuna Expressway To Reach Agra.<Br>
                        <Br>
                        It Takes Nearly 3 Hours To Cover This Distance Between The Two Cities, Which Is Approx 210 Kms.
                        Transfer To The Hotel. Relax And Enjoy Lip-Smacking Dinner. Overnight Stay At Hotel In Agra.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 3</span> Jaipur</h4>
                  </div>
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">Proceed Early At 6:00 A.M. To Visit the Taj Mahal During Sunrise. Cruising Past The Majestic
                        Arches At The Entry, You Will Be Zapped By The Fascinating View Of The Taj Mahal. The Rays Of
                        The Rising Sun Fill The Sky With Beautiful Hues Of Yellow, Orange, And Envelopes The Pure White
                        Marble Edifice. This Charismatic View Of Its Unparalleled Beauty Will Etched In Your Memory.
                        Come Back To The Hotel For A Delicious And Wholesome Breakfast. Leave The Hotel And Proceed To
                        Visit Agra Fort, Who Is An Outstanding Example Of The Ancient Architectural Style.<Br>
                        <Br>
                        Constructed In Red Sandstone By Emperor Akbar, The Massive Fort Lies On The Banks Of River
                        Yamuna. Post-Lunch Depart For Jaipur Via Fatehpur Sikri. Take A Halt At The Famous UNESCO World
                        Heritage Site, Which Is Located 40 Kms From Agra And See Buland Darwaza, Jodha Bhai Palace, And
                        Tomb Of Salim Chishti. Proceed For Jaipur. Overnight Stay In Jaipur Jaipur.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 4</span> Jaipur - Delhi (260 Kms)</h4>
                  </div>
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">Have Early Breakfast And Proceed For A Sightseeing Tour Of Jaipur At 8 A.M. With Our Local Tour
                        Guide. Visit Amer Fort And Enjoy A Thrilling Elephant Ride To Reach The Hilltop. You Will Also
                        Be Taken To The City Palace, Which Is A Popular Landmark In Jaipur. See Hawa Mahal, Jantar
                        Mantar, And Drive Past The Scenic Jal Mahal. Explore The Bustling And Colorful Local Market In
                        The Pink City. In The Evening Drive To Delhi To Cover A Distance Of 280 Kms In Nearly Five
                        Hours. Transfer To Delhi Airport And Onward Destination.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="tour-listing-details__plan">
              <h3 class="tour-listing-details__title tour-listing-details__plan-title">Golden Triangle Tour 4 Days FAQs</h3>
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="priority-seo-faq">
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title"><h4>Why choose the 4-day Golden Triangle tour?</h4></div>
                  <div class="accrodion-content"><div class="inner"><p style="margin-top: 0.75rem;">The 4-day itinerary gives you a better balance than the 3-day express route, with time for Delhi sightseeing, Agra and Jaipur without making the trip too long.</p></div></div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title"><h4>Can I extend this tour to Rajasthan?</h4></div>
                  <div class="accrodion-content"><div class="inner"><p style="margin-top: 0.75rem;">Yes, you can extend this route to the Rajasthan Desert Tour, Udaipur, Pushkar, Ranthambore or the full Golden Triangle with Rajasthan itinerary.</p></div></div>
                </div>
              </div>
            </div>
