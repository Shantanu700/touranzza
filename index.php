...
<head>
  ...
  <style>
    ...
    /* ── MUCH NARROWER SLIDER CONTAINER (55% width) ── */
    ...
    /* ── REDUCE TOUR LISTING SECTION PADDING ── */
    .tour-listing-one {
      padding: 40px 0 !important;
    }

    /* ── REDUCE SEC-TITLE MARGINS ── */
    .sec-title {
    ...
    /* ── REDUCE TOUR CARD SPACING AND SIZING ── */
          ...
          <div
            ...
            <div class="item">
              <div class="tour-listing__card"> <a href="golden-triangle-tour-with-ajmer-and-pushkar"
                ...
                <a href="javascript:void(0);" class="tour-listing__card-wishlist"><span class="icon-heart"></span></a>
                <div class="tour-listing__card-content">
                  <h3 class="tour-listing__card-title"><a href="golden-triangle-tour-with-ajmer-and-pushkar">Golden Triangle
                      Tour with Ajmer Pushkar</a></h3>
                  <p class="tour-listing__card-text text-small">Experience authentic Rajasthani spirituality and royal
                    heritage with private guided temple visits, desert camel safaris, and luxury stays at heritage
                    palaces.</p>
                  <div class="tour-listing__card-inner-content">
                    <div class="tour-listing__card-location-box"> <span class="icon-location-1"></span>
