...
<head>
  ...
  <link rel="canonical" href="https://touranzza.com/same-day-agra-tour-by-gatimaan-express" />
  <title>Same Day Agra Tour by Gatimaan Express | Taj Mahal Day Trip from Delhi</title>
  <!-- favicons Icons -->
  ...
  <meta name="description" content="Take a same day Agra tour by Gatimaan Express from Delhi. Visit the Taj Mahal, Agra Fort and Baby Taj with a private guide, return train tickets and seamless transfers by Touranzza." />
  <!-- fonts -->
      ...
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/train-trip1.webp" alt="listing-details-carousel">
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/agra-4.webp" alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/train-trip1.webp"}, {"src": "assets/images/tours/agra-4.webp"}, {"src": "assets/images/tours/agra-3.webp"}, {"src": "assets/images/tours/agra-2.webp"}, {"src": "assets/images/tours/train-trip.webp"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/train-trip.webp" alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/train-trip1.webp"}, {"src": "assets/images/tours/agra-4.webp"}, {"src": "assets/images/tours/agra-3.webp"}, {"src": "assets/images/tours/agra-2.webp"}, {"src": "assets/images/tours/train-trip.webp"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              <!-- /.tour-listing-details__top-carousel-overlay -->
          ...
          <div class="tour-listing-details__destination-row row">
            <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
              <div class="tour-listing-details__destination-left">
                <h1 class="tour-listing-details__dastination-title">Same Day Agra Tour By Gatimaan Express</h1>
          ...
          <div class="col-xl-8">
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Wake up and get ready till 06:30 AM – Pick up from the hotel to the railway station</span>
                    </h4>
                  </div>
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">Taj Mahal – Considered as one of the beautiful structures (fascination) in India and one of the
                        ...
                        greenery that makes your visit-worthy.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p style="margin-top: 0.75rem;">Well ahead visit Itimad-Ud-Daulah which is in the main called child Taj Mahal and it is also
                        ...
                        traveler must see this baby Taj during their trip to the city.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
            ...
            <div class="tour-listing-details__plan">
              ...
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                <div class="accrodion-title"><h4>What is the Gatimaan Express?<span class="faq-arrow" style="float:right;color:#ffc202;font-size:13px;transition:transform 0.3s;"><i class="fas fa-chevron-down"></i></span></h4></div>
